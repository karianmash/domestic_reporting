...
<?php require_once('includes/front_page_top_nav.php'); ?>
    ...
    <div class="container">
      ...
      <!-- Page Heading -->
      <h1 class="my-4">Rescue Centers</h1>

      <?php 

        $sql = "SELECT centers.center_id, centers.center_image, centers.center_name, categories.category_name, counties.county_name, centers.center_phone, centers.center_email, centers.center_service_desc FROM centers INNER JOIN categories ON centers.center_category = categories.category_id INNER JOIN counties ON centers.center_county = counties.county_id WHERE centers.center_category = 2";
